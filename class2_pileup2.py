...
#new micro mega blast gets all bat assemblies from the new fa file and makes LWGV for them
#also puts all of the assemblies into _bat.fa
import sys
import os
import subprocess
import csv
...
outfile=open('class2_pileups.csv','w')
...
for row in reader:
    ...
    os.system('blast4.sh '+ gene+'_bat_rev.fa rev')
